...
class TestIntegration(unittest.TestCase):
    ...
    def test_main_recommend_workflow(self, mock_config, mock_setup_logging, mock_json_data, 
                                   mock_check_candidates, mock_filter_brews, 
                                   mock_get_casks, mock_get_apps, mock_check_deps):
    ...
    @patch('versiontracker.__main__.setup_logging')
    @patch('versiontracker.__main__.config')
    def test_main_strict_recommend_workflow(self, mock_config, mock_setup_logging, mock_json_data, 
                                         mock_check_candidates, mock_filter_brews, 
                                         mock_get_casks, mock_get_apps, mock_check_deps):
    ...
    @patch('versiontracker.__main__.setup_logging')
    @patch('versiontracker.__main__.config')
    def test_main_apps_workflow(self, mock_config, mock_setup_logging, 
                               mock_json_data, mock_get_apps, mock_check_deps):
